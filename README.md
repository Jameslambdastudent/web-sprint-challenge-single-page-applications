...
The useRouteMatch hook attempts to match the current URL in the same way that a <Route> would. It's mostly useful for getting access to the match data .

1. How would you explain form validation to someone who has never programmed before?
To ensure someone is using real information on your form syou will setup validation for different input fields.
1. In 1-2 sentences, define end to end testing.
Testing is when you wanna test your code to see if any errors exist in your form.
